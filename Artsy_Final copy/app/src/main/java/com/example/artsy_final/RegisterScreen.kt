...
fun RegisterScreen(navController: NavController){
    ...
    Scaffold(
        ...
        var hasfnameFocus by remember { mutableStateOf(false) }
        ...
        var isfnameError by remember { mutableStateOf(false) }
        var errorfnameMessage by remember { mutableStateOf("") }
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { fname = it
                        if (hasfnameFocus && fname.isNotEmpty()) {
                            isfnameError = false
                            errorfnameMessage = ""
                        }},
                    ...
                    modifier = Modifier
                        .onFocusChanged { focusState ->
                            if (focusState.isFocused) {
                                ...
                                if (fname.isEmpty()) {
                                    isfnameError = true
                                    errorfnameMessage = "Full name cannot be empty"
                                }
                            } else if (hasfnameFocus) {
                ...
                Button(
                    onClick = {
                        loading = true
                        invalid = false
                        val call = RetrofitInstance.api.register(RegisterRequest(fname, text, password))
                            ...
                            override fun onResponse(call: Call<RegisterResponse>, response: Response<RegisterResponse>) {
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    if (registerResponse?.success == true){
                                        val userName = registerResponse.user?.name
                                        val userEmail = registerResponse.user?.email
                                        val userID = registerResponse.user?.gravitarID
